...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=36, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
var gCurSld = gPrevSld = 1, g_offset = -1, gNtsOpen = gHasNts = gOtlTxtExp = gNarrationPaused = false, gOtlOpen = true
...
var gDocTable = new Array(
   ...
   new hrefList("slide0036.htm", 1, 4),
   new hrefList("slide0039.htm", 1, 5),
   new hrefList("slide0040.htm", 1, 6),
   new hrefList("slide0041.htm", 1, 7),
   new hrefList("slide0042.htm", 1, 8),
   new hrefList("slide0038.htm", 1, 9),
   new hrefList("slide0043.htm", 1, 10),
   new hrefList("slide0044.htm", 1, 11),
   new hrefList("slide0045.htm", 1, 12),
   new hrefList("slide0046.htm", 1, 13),
   new hrefList("slide0047.htm", 1, 14),
   new hrefList("slide0049.htm", 1, 15),
   new hrefList("slide0050.htm", 1, 16),
   new hrefList("slide0051.htm", 1, 17),
   new hrefList("slide0056.htm", 1, 18),
   new hrefList("slide0060.htm", 1, 19),
   new hrefList("slide0059.htm", 1, 20),
   new hrefList("slide0054.htm", 1, 21),
   new hrefList("slide0061.htm", 1, 22),
   new hrefList("slide0063.htm", 1, 23),
   new hrefList("slide0037.htm", 1, 24),
   new hrefList("slide0062.htm", 1, 25),
   new hrefList("slide0065.htm", 1, 26),
   new hrefList("slide0064.htm", 1, 27),
   new hrefList("slide0067.htm", 1, 28),
   new hrefList("slide0068.htm", 1, 29),
   new hrefList("slide0069.htm", 1, 30),
   new hrefList("slide0070.htm", 1, 31),
   new hrefList("slide0071.htm", 1, 32),
   new hrefList("slide0072.htm", 1, 33),
   new hrefList("slide0073.htm", 1, 34),
   new hrefList("slide0033.htm", 1, 35),
   new hrefList("slide0035.htm", 1, 36)
);
