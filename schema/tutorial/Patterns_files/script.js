...
var gDocTable = new Array(
   ...
   new hrefList("slide0088.htm", 1, 3),
   new hrefList("slide0089.htm", 1, 4),
   new hrefList("slide0090.htm", 1, 5),
   new hrefList("slide0091.htm", 1, 6),
   new hrefList("slide0092.htm", 1, 7),
   new hrefList("slide0093.htm", 1, 8),
   new hrefList("slide0094.htm", 1, 9),
   new hrefList("slide0095.htm", 1, 10),
   new hrefList("slide0096.htm", 1, 11),
   new hrefList("slide0098.htm", 1, 12),
   new hrefList("slide0097.htm", 1, 13),
   new hrefList("slide0099.htm", 1, 14),
   new hrefList("slide0100.htm", 1, 15),
   new hrefList("slide0101.htm", 1, 16),
   new hrefList("slide0102.htm", 1, 17),
   new hrefList("slide0107.htm", 1, 18),
   new hrefList("slide0103.htm", 1, 19),
   new hrefList("slide0104.htm", 1, 20),
   new hrefList("slide0108.htm", 1, 21),
   new hrefList("slide0105.htm", 1, 22),
   new hrefList("slide0106.htm", 1, 23),
   new hrefList("slide0033.htm", 1, 24),
   new hrefList("slide0035.htm", 1, 25)
);
