...
var gDocTable = new Array(
   ...
   new hrefList("slide0082.htm", 1, 4),
   new hrefList("slide0074.htm", 1, 5),
   new hrefList("slide0081.htm", 1, 6),
   new hrefList("slide0083.htm", 1, 7),
   new hrefList("slide0084.htm", 1, 8),
   new hrefList("slide0085.htm", 1, 9),
   new hrefList("slide0086.htm", 1, 10),
   new hrefList("slide0087.htm", 1, 11),
   new hrefList("slide0089.htm", 1, 12),
   new hrefList("slide0091.htm", 1, 13),
   new hrefList("slide0093.htm", 1, 14),
   new hrefList("slide0092.htm", 1, 15),
   new hrefList("slide0094.htm", 1, 16),
   new hrefList("slide0095.htm", 1, 17),
   new hrefList("slide0096.htm", 1, 18),
   new hrefList("slide0090.htm", 1, 19),
   new hrefList("slide0080.htm", 1, 20),
   new hrefList("slide0078.htm", 1, 21),
   new hrefList("slide0079.htm", 1, 22),
   new hrefList("slide0033.htm", 1, 23),
   new hrefList("slide0035.htm", 1, 24)
);
