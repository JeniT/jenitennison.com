...
var gDocTable = new Array(
   ...
   new hrefList("slide0038.htm", 1, 6),
   new hrefList("slide0039.htm", 1, 7),
   new hrefList("slide0050.htm", 1, 8),
   new hrefList("slide0051.htm", 1, 9),
   new hrefList("slide0052.htm", 1, 10),
   new hrefList("slide0053.htm", 1, 11),
   new hrefList("slide0062.htm", 1, 12),
   new hrefList("slide0040.htm", 1, 13),
   new hrefList("slide0054.htm", 1, 14),
   new hrefList("slide0042.htm", 1, 15),
   new hrefList("slide0041.htm", 1, 16),
   new hrefList("slide0043.htm", 1, 17),
   new hrefList("slide0044.htm", 1, 18),
   new hrefList("slide0045.htm", 1, 19),
   new hrefList("slide0046.htm", 1, 20),
   new hrefList("slide0047.htm", 1, 21),
   new hrefList("slide0048.htm", 1, 22),
   new hrefList("slide0049.htm", 1, 23),
   new hrefList("slide0063.htm", 1, 24),
   new hrefList("slide0055.htm", 1, 25),
   new hrefList("slide0056.htm", 1, 26),
   new hrefList("slide0057.htm", 1, 27),
   new hrefList("slide0058.htm", 1, 28),
   new hrefList("slide0059.htm", 1, 29),
   new hrefList("slide0060.htm", 1, 30),
   new hrefList("slide0061.htm", 1, 31),
