...
var gDocTable = new Array(
   ...
   new hrefList("slide0089.htm", 1, 3),
   new hrefList("slide0090.htm", 1, 4),
   new hrefList("slide0091.htm", 1, 5),
   new hrefList("slide0092.htm", 1, 6),
   new hrefList("slide0093.htm", 1, 7),
   new hrefList("slide0094.htm", 1, 8),
   new hrefList("slide0095.htm", 1, 9),
   new hrefList("slide0033.htm", 1, 10),
   new hrefList("slide0035.htm", 1, 11)
);
